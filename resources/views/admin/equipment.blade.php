...
<head>
    ...
    <!-- Page Title  -->
    <title>Sisemping | Master Equipment</title>
    <!-- StyleSheets  -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">List Master Equipment</h3>
                                        </div>
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3">
                                                <li>
                                                    <a href="{{ route('master.equipment.create') }}" class="btn btn-dim btn-outline-primary">
                                                        <em class="icon ni ni-plus-circle"></em>&nbsp;Create New Equipment
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>

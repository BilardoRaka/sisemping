                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="#" class="logo-link">
                                <img class="logo-dark logo-img logo-img-lg" src="/images/sisemping.png" alt="logo-dark">
                            </a>
                        </div>
                            ...
                            <div class="card-inner card-inner-lg">
                                ...
                                @method('POST')
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-6">
                                                <button type="submit" class="btn btn-lg btn-dim btn-outline-primary btn-block col-6">Login</button>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{ route('dashboard.index') }}" class="btn btn-lg btn-dim btn-outline-danger btn-block col-6">Kembali</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                <p class="text-center mt-2">
                                    Belum punya akun? Daftar <a href="{{ route('registration') }}">disini</a>
                                </p>
                            </div>
                        </div>
                    </div>
